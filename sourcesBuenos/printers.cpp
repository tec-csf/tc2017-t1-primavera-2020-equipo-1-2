...
void PrintTable(vector<string> vecComp, vector<int> contOE, int maxLinea)
{
    ...
    cout << setfill(' ') << setw(maxLinea / 2 + 10) << "|" << setfill(' ');
    cout << setw(10) << "OE" << setfill(' ') << setw(10) << "|" << setfill(' ') << setw(20) << "Polinomio|" << endl;
    cout << "--------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
    ...
    for (int i = 0; i < cont; i++)
    {
        ...
        cout<< setfill(' ') << setw(maxLinea + 10) << /*vecComp.at(i)*/ "warara"<<"|";
        cout<< setfill(' ') << setw(10) <<  contOE.at(i) << setfill(' ') << setw(10) << "|" << endl;
    }
